...
- [Pre-launch] Capture how-it-works screenshots — 5 PNGs in `/public/how-it-works/` are 2.7 KB placeholder blanks. Follow `docs/how-it-works-screenshot-runbook.md` (~15 min). See `.planning/todos/pending/2026-04-16-capture-how-it-works-screenshots.md`.
